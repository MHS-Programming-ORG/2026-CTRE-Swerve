...
public class RobotContainer {
    ...
    //Trench Shooting
    joystick.rightTrigger().whileTrue(new FixedShootCommand(shooterSubsystem, m_ConveyorSubsystem, 25*0.8, 0.5, 70)); //kicker vel: 60 | 49
    ...
    //Passing
    joystick.leftTrigger().whileTrue(new FixedShootCommand(shooterSubsystem, m_ConveyorSubsystem, 25*0.8, 0.5, 70)); //run kicker at 75% //kicker vel: 80 
    joystick.leftTrigger().and(conveyorRunning).whileTrue(new AgitatePivotCommand(m_intakePivot, m_intakeSubsystem));
